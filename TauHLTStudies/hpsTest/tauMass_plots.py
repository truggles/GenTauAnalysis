...
def plotTauMass( c, plotBase, saveTitle, plotTitle, hpsMass00, hpsMass01, hpsMass10, hpsMassOther, hpsMass, coneMass, offlineMass ) :
    ...
    offlineMass.SetLineStyle( 2 )
    offlineMass.SetLineColor( ROOT.kGreen+1 )
    ...
    leg = buildLegend( [hpsMass00, hpsMass01, hpsMass10, hpsMassOther, hpsMass, coneMass, offlineMass], 
        ['HPS 1-prong', 'HPS 1-prong+1piZero', 'HPS 3-prong', 'HPS other', 'HPS Mass', 'Cone-based Mass', 'Offline Mass'], hpsMass=True )
    leg.Draw()
...
def buildLegend( items, names, hpsMass=False ) :
    if hpsMass :
        legend = ROOT.TLegend(0.3, 0.60, 0.83, 0.88)
...
plotBase='/afs/cern.ch/user/t/truggles/www/hps_at_hlt/tau_mass/'+dataName+'v1/'
