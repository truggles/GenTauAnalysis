...
// Class:      HPSTauHLTStudiesMiniAODAnalyzer
// 
/**\class HPSTauHLTStudiesMiniAODAnalyzer HPSTauHLTStudiesMiniAODAnalyzer.cc THRAnalysis/TauHLTStudies/plugins/HPSTauHLTStudiesMiniAODAnalyzer.cc
...
class HPSTauHLTStudiesMiniAODAnalyzer : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
   public:
      explicit HPSTauHLTStudiesMiniAODAnalyzer(const edm::ParameterSet&);
      ~HPSTauHLTStudiesMiniAODAnalyzer();
   ...
   private:
      ...
      float getGenMatchNumber( pat::TauRef& tau,
...
//
HPSTauHLTStudiesMiniAODAnalyzer::HPSTauHLTStudiesMiniAODAnalyzer(const edm::ParameterSet& iConfig) :
...
HPSTauHLTStudiesMiniAODAnalyzer::~HPSTauHLTStudiesMiniAODAnalyzer()
{
...
void
HPSTauHLTStudiesMiniAODAnalyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  using namespace edm;
...
void 
HPSTauHLTStudiesMiniAODAnalyzer::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
HPSTauHLTStudiesMiniAODAnalyzer::endJob() 
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
HPSTauHLTStudiesMiniAODAnalyzer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
float
HPSTauHLTStudiesMiniAODAnalyzer::getGenMatchNumber( pat::TauRef& tau,
        edm::Handle<std::vector<reco::GenJet>> genHTaus,
        edm::Handle<std::vector<reco::GenJet>> genETaus,
        edm::Handle<std::vector<reco::GenJet>> genMTaus,
        edm::Handle<std::vector<reco::GenParticle>> genParticles) {
...
void
HPSTauHLTStudiesMiniAODAnalyzer::getL1TauMatch( pat::TauRef& tau,
        edm::Handle<BXVector<l1t::Tau>> l1Taus, float& l1TauMatch, float& l1TauPt, float& l1TauIso ) {
    l1TauMatch = -1;
    l1TauPt = -1;
    l1TauIso = -1;
...
DEFINE_FWK_MODULE(HPSTauHLTStudiesMiniAODAnalyzer);
