...
// Copied from https://github.com/cms-sw/cmssw/blob/master/RecoTauTag/HLTProducers/src/L2TauPixelIsoTagProducer.cc

//#include "THRAnalysis/TauHLTStudies/interface/NewL2TauPixelIsoTagProducer.h"
...
class NewL2TauPixelIsoTagProducer : public edm::global::EDProducer<>
{
public:

  explicit NewL2TauPixelIsoTagProducer(const edm::ParameterSet&);

  ~NewL2TauPixelIsoTagProducer() override {};
...
NewL2TauPixelIsoTagProducer::NewL2TauPixelIsoTagProducer(const edm::ParameterSet& conf):
...
void NewL2TauPixelIsoTagProducer::produce(edm::StreamID sid, edm::Event& ev, const edm::EventSetup& es) const
{
...
void NewL2TauPixelIsoTagProducer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) 
{
  ...
  descriptions.add("NewL2TauPixelIsoTagProducer",desc);

}

//define this as a plug-in
DEFINE_FWK_MODULE(NewL2TauPixelIsoTagProducer);
