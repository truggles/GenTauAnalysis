...
// Class:      TauHLTStudiesMiniAODAnalyzer
// 
/**\class TauHLTStudiesMiniAODAnalyzer TauHLTStudiesMiniAODAnalyzer.cc THRAnalysis/TauHLTStudies/plugins/TauHLTStudiesMiniAODAnalyzer.cc
...
class TauHLTStudiesMiniAODAnalyzer : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
   public:
      explicit TauHLTStudiesMiniAODAnalyzer(const edm::ParameterSet&);
      ~TauHLTStudiesMiniAODAnalyzer();
...
//
TauHLTStudiesMiniAODAnalyzer::TauHLTStudiesMiniAODAnalyzer(const edm::ParameterSet& iConfig) :
...
TauHLTStudiesMiniAODAnalyzer::~TauHLTStudiesMiniAODAnalyzer()
{
...
void
TauHLTStudiesMiniAODAnalyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  using namespace edm;
...
void 
TauHLTStudiesMiniAODAnalyzer::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
TauHLTStudiesMiniAODAnalyzer::endJob() 
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
TauHLTStudiesMiniAODAnalyzer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
float
TauHLTStudiesMiniAODAnalyzer::getGenMatchNumber( pat::TauRef& tau,
        edm::Handle<std::vector<reco::GenJet>> genHTaus,
        edm::Handle<std::vector<reco::GenJet>> genETaus,
        edm::Handle<std::vector<reco::GenJet>> genMTaus,
        edm::Handle<std::vector<reco::GenParticle>> genParticles) {
...
DEFINE_FWK_MODULE(TauHLTStudiesMiniAODAnalyzer);
